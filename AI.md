# 🗺️ The Zero-to-Hero Artificial Intelligence & Machine Learning Roadmap
...
╔════════════════════════════════════════════════════════════════════════════╗
║                                                                            ║
║   🗺️   ZERO-TO-HERO AI & MACHINE LEARNING ROADMAP                          ║
...
| 🛠️ | **AI Engineer** | How do we *ship* reliable AI systems users trust? | Prompts, RAG, agents, evals, cost/latency, guardrails |
...
| 10 | 👁️ | [CNNs & Vision](#phase-10) | Learn spatial structure | Explain convolution + transfer learning |
...
| 16 | 🎛️ | [Fine-tuning](#phase-16) | Specialize models efficiently | Justify LoRA vs full FT vs RAG |
...
- 🏋️ Code-first DL: [fast.ai Practical Deep Learning](https://course.fast.ai/)
...
- 🗺️ 2026 ship path: [Vibe Engines AI Engineer Roadmap](https://vibeengines.com/roadmap/ai-engineer)
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 01 / 20  ·  🧠  AI THINKING                                           ║
║ TRACK: FOUNDATIONS                                                         ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Learning from data — what AI is, and what it is not                        ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Expert systems and if-else forests could not keep up with high-dimensional, shifting data. Maintenance cost exploded. Nobody could list all rules for "is this photo a cat?"
...
- 🎞️ [Advice for ML beginners (Karpathy / Lex)](https://www.youtube.com/watch?v=I2ZK3ngNvvI)
- 🕹️ [Google ML Crash Course](https://developers.google.com/machine-learning/crash-course)
- 📄 [Vibe Engines AI Engineer Roadmap](https://vibeengines.com/roadmap/ai-engineer)
- 🐙 [josephmisiti/awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning)
- 🏋️ Kaggle: pick any Intro course dataset and state the prediction task in one sentence
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** People reported training accuracy as success. Products collapsed on real users. Leaderboards were gamed by test-set peeking.
...
- 🏋️ Hold out a test set on any toy CSV and refuse to touch it until the end
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 02 / 20  ·  📐  MATH FOR ML                                            ║
║ TRACK: FOUNDATIONS                                                         ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Vectors, probability, gradients — the minimum toolkit that unlocks models  ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** People treated ML as GUI buttons. They could not debug shapes, norms, or why cosine similarity works.
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Without probability, classification scores are uncalibrated vibes. Without gradients, "learning" is random search.

👁️ **VISUAL LEARNING**

- 🎬 [Gradient descent, how neural networks learn (3Blue1Brown)](https://www.youtube.com/watch?v=IHZwWFHWa-w)
- 🎥 [Gradient Descent, Step-by-Step (StatQuest)](https://www.youtube.com/watch?v=sDv4f4s2SB8)
- 🎞️ [Stochastic Gradient Descent (StatQuest)](https://www.youtube.com/watch?v=vMh0zPT0tLI)
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 03 / 20  ·  🐍  PYTHON FOR AI                                         ║
║ TRACK: FOUNDATIONS                                                         ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Arrays, tables, plots — the daily tools before frameworks                  ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Pure Python numeric code could not train real models. People bounced off ML because tooling felt impossible.
...
- 🕹️ Google Colab scratch notebook
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Models trained on garbage. "Accuracy 99%" on imbalanced labels fooled teams.

👁️ **VISUAL LEARNING**

- 📄 pandas getting started
- 🏋️ Kaggle pandas courses
- 🎞️ Any short EDA walkthrough you trust - then do your own
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 04 / 20  ·  📊  CLASSICAL ML                                          ║
║ TRACK: SUPERVISED BASICS                                                   ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Regression and classification — strong baselines that still ship           ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Ad hoc curve fitting without a shared objective. No principled way to compare models.
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Thresholding linear regression for classes is statistically awkward. Accuracy alone hides probability quality.

👁️ **VISUAL LEARNING**

- 🎬 StatQuest logistic regression
- 📄 scikit-learn LogisticRegression docs
- 🕹️ Desmos/sigmoid sketch
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 05 / 20  ·  🎯  EVALUATION & GENERALIZATION                           ║
║ TRACK: SUPERVISED BASICS                                                   ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Metrics, bias-variance, CV — prove the model works for the right reasons   ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Leaderboards optimized the wrong number. Hospitals and fraud teams shipped harmful policies.

👁️ **VISUAL LEARNING**

- 🎬 StatQuest ROC and confusion matrix
- 📄 sklearn metrics docs
- 🕹️ Confusion matrix interactive explainers
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** One lucky split greenlit models. Pipelines that scaled using the full dataset leaked test information.
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 06 / 20  ·  🌳  TREES & ENSEMBLES                                     ║
║ TRACK: SUPERVISED BASICS                                                   ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Nonlinear tabular models — forests and boosting as default baselines       ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Linear models missed interactions. Single deep trees memorized noise.

👁️ **VISUAL LEARNING**

- 🎬 StatQuest decision trees / random forests
- 📄 sklearn ensemble docs
- 🕹️ Visual tree toy datasets
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** RF plateaued. Pure deep trees overfit. Need additive refinement with shrinkage.
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 07 / 20  ·  🧬  NEURAL NETS BASICS                                    ║
║ TRACK: DEEP LEARNING                                                       ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Layers, activations, capacity — differentiable function composition        ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Hand-designed features + linear classifiers hit ceilings on perception tasks.
...
- 🎞️ [Karpathy micrograd intro](https://www.youtube.com/watch?v=VMj-3S1tku0)
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Train accuracy 100%, test accuracy coin-flip. "Just add layers" culture.

👁️ **VISUAL LEARNING**

- 📄 CS231n regularization notes
- 🎬 StatQuest dropout / regularization intuition
- 🏋️ Watch val curves in any Keras/PyTorch tutorial
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 08 / 20  ·  🔁  BACKPROP & OPTIMIZERS                                 ║
║ TRACK: DEEP LEARNING                                                       ║
╠════════════════════════════════════════════════════════════════════════════╣
║ How nets learn — reverse-mode differentiation and modern optimizers        ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Training deep nets was computationally hopeless or hand-derived per architecture.
...
- 🎞️ [StatQuest Backpropagation Main Ideas](https://www.youtube.com/watch?v=IN2XmBhILt4)
- 🏋️ [Karpathy micrograd video](https://www.youtube.com/watch?v=VMj-3S1tku0)
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Training diverged or crawled. People blamed models when optimizers/hyperparams were wrong.
...
- 📄 PyTorch optim docs
- 🎞️ Distill.pub / optimizer visualizations (search)
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 09 / 20  ·  🔥  PYTORCH DEEP PRACTICE                                 ║
║ TRACK: DEEP LEARNING                                                       ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Tensors, Dataset/DataLoader, training loops — the craft of implementation  ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Researchers reimplemented backprop per project. Portability and speed suffered.
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Weeks wasted "tuning" a broken loader.

👁️ **VISUAL LEARNING**

- 📄 PyTorch DataLoading tutorial
- 🐙 fast.ai training philosophy - plot losses early
- 🕹️ TensorBoard / wandb free tiers
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 10 / 20  ·  👁️  CNNs & VISION                                         ║
║ TRACK: DEEP LEARNING                                                       ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Spatial inductive bias — convolutions and transfer learning                ║
╚════════════════════════════════════════════════════════════════════════════╝
```

# 👁️ PHASE 10 - CNNs and Computer Vision
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Hand-crafted SIFT-like features + shallow classifiers. Fragile and expensive.
...
- 🕹️ [Netron](https://github.com/lutzroeder/netron) model visualizer
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Every startup trained from random init - slow, data-hungry, worse accuracy.

👁️ **VISUAL LEARNING**

- 🏋️ [fast.ai](https://course.fast.ai/) first lessons - transfer learning first
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 11 / 20  ·  📜  SEQUENCE MODELS                                       ║
║ TRACK: REPRESENTATIONS                                                     ║
╠════════════════════════════════════════════════════════════════════════════╣
║ RNNs/LSTMs — why sequential state helped, and why it was not enough        ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Fixed-size bags of words ignored order. N-grams exploded combinatorially.
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Vanilla RNNs failed on long sentences. Translation quality stalled.

👁️ **VISUAL LEARNING**

- 🎬 Colah's LSTM blog (classic written visual)
- 📄 CS224n LSTM lectures
- 🎞️ [Karpathy makemore](https://www.youtube.com/watch?v=PaCmpygFfXo)
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 12 / 20  ·  🧲  EMBEDDINGS                                            ║
║ TRACK: REPRESENTATIONS                                                     ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Meaning as vectors — Word2Vec to modern embedding spaces                   ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Sparse bag-of-words, gigantic dimensions, no notion of similarity.

👁️ **VISUAL LEARNING**

- 🎬 [Word Embedding and Word2Vec (StatQuest)](https://www.youtube.com/watch?v=viZrOnJclY0)
- 🎥 [How word vectors encode meaning (3Blue1Brown)](https://www.youtube.com/watch?v=FJtFZwbvkI4)
- 🎞️ [Word Embeddings: Word2Vec (Hex)](https://www.youtube.com/watch?v=iErmK_sJtag) · [IBM](https://www.youtube.com/watch?v=wgfSDrqYMJ4)
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Keyword search missed synonyms. Brute-force cosine over millions of vectors was too slow.

👁️ **VISUAL LEARNING**

- 📄 FAISS / vector DB intros (Pinecone/Chroma blogs - conceptual)
- 🐙 LlamaIndex / LangChain embedding docs (Phase 15)
- 🎞️ IBM / ByteByteGo embedding explainers
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 13 / 20  ·  ⚡  TRANSFORMERS                                          ║
║ TRACK: FOUNDATION MODELS                                                   ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Attention is the new workhorse — the architecture behind modern AI         ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Slow training, weak long-range dependency learning, complex seq2seq+attention hybrids still bottlenecked by recurrence.
...
- 🎞️ [Transformers Step-by-Step (ByteByteGo)](https://www.youtube.com/watch?v=avjX3QrYkls) · [Google Cloud Tech](https://www.youtube.com/watch?v=SZorAJ4I-sA)
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** One architecture forced into every task. Training was art without scaling intuition.

👁️ **VISUAL LEARNING**

- 🎞️ [Grant Sanderson talk on visualizing transformers](https://www.youtube.com/watch?v=KJtZARuO3JY)
- 📄 HF course transformer chapters
- 🐙 [huggingface/transformers](https://github.com/huggingface/transformers)
- 🏋️ [huggingface/course](https://github.com/huggingface/course)
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 14 / 20  ·  💬  LLMs & PROMPTING                                      ║
║ TRACK: LLM APPS                                                            ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Foundation models as APIs — tokens, context, and prompt engineering craft  ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** People pasted novels into prompts, got truncated mid-thought, blamed "the model is dumb."
...
- 🗺️ [Vibe Engines AI Engineer](https://vibeengines.com/roadmap/ai-engineer)
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** One-off prompts in notebooks; production variance; unsafe tool calls.

👁️ **VISUAL LEARNING**

- 🗺️ Vibe Engines CRISP prompt lab
- 📄 Anthropic/OpenAI prompting guides
- 🎞️ CoT / few-shot explainers
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 15 / 20  ·  📚  RAG SYSTEMS                                           ║
║ TRACK: LLM APPS                                                            ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Ground generation in your data — chunk, retrieve, cite, evaluate           ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** LLMs invented policies and citations. Fine-tuning every doc change was slow and still hallucinated.
...
- 🎞️ [codebasics RAG](https://www.youtube.com/watch?v=dDkynerzV-Q) · [Scalable RAG (ByteMonk)](https://www.youtube.com/watch?v=4KiiKQ9RVvA)
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Demos worked on blog posts; enterprise queries failed on SKUs and multi-doc reasoning.
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 16 / 20  ·  🎛️  FINE-TUNING                                           ║
║ TRACK: LLM APPS                                                            ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Specialize models — SFT, LoRA/QLoRA, and preference optimization literacy   ║
╚════════════════════════════════════════════════════════════════════════════╝
```

# 🎛️ PHASE 16 - Fine-Tuning and Alignment Basics
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Only labs with giant clusters could specialize models. Everyone else was stuck with brittle prompts.
...
- 🎞️ [Keerti Purswani LoRA internals](https://www.youtube.com/watch?v=3LGw54I9FDs)
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Base models were witty but unsafe/unhelpful. Pure SFT still produced toxic or unusable outputs.

👁️ **VISUAL LEARNING**

- 📄 HF alignment handbook / llm-course scientist track
- 🎞️ High-level RLHF explainers (IBM/ByteByteGo style)
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 17 / 20  ·  🤖  AGENTS & TOOLS                                        ║
║ TRACK: LLM APPS                                                            ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Models that act — tool calling, ReAct loops, memory, and control           ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Copy-paste between ChatGPT and dashboards. No closed-loop automation. Hallucinated API results.
...
- 🎞️ [Building Effective Agents with LangGraph](https://www.youtube.com/watch?v=aHCDrAbH_go) · [LangChain vs LangGraph (IBM)](https://www.youtube.com/watch?v=qAF1NjEVHhY)
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Stateless chats forgot; agents repeated work; refunds shipped without approval.

👁️ **VISUAL LEARNING**

- 🎞️ LangGraph official videos above
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 18 / 20  ·  🏭  EVAL, SAFETY & MLOps                                  ║
║ TRACK: PRODUCTION                                                          ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Ship responsibly — metrics, tracing, guardrails, cost, deployment          ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Prompt edits silently broke edge cases. Model swaps changed tone overnight. No golden sets.
...
- 🗺️ Vibe Engines production track
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Demo apps on weekend; Monday production incident; no traces to debug which tool fired.
...
- 🎞️ Observability vendor tutorials (LangSmith etc.) - concepts matter more than brand
...
```
╔════════════════════════════════════════════════════════════════════════════╗
║ PHASE 19 / 20  ·  🧰  PORTFOLIO & PROJECTS                                  ║
║ TRACK: PROOF                                                               ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Ship artifacts — notebooks, apps, evals, and clear READMEs                 ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Tutorial clones with no eval and no original thought.
...
- 🏋️ fast.ai / HF course end projects
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** "Works on my GPU" folklore. Hidden scraped data. No discussion of harm.

👁️ **VISUAL LEARNING**

- 📄 Model cards / data cards examples (HF)
- 🐙 EthicalML awesome list
- 🏋️ Write one blog from a lab failure
...
║ TRACK: HIRE                                                                ║
╠════════════════════════════════════════════════════════════════════════════╣
║ Say it out loud — ML drills, LLM systems, and debugging stories            ║
╚════════════════════════════════════════════════════════════════════════════╝
```
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Candidates recited transformer slogans but failed train/test leakage questions.
...
⚠️ **THE PROBLEM BEFORE THIS EXISTED:** Diagrams with only "LLM in the middle" and no failure modes.
