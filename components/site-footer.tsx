...
export function SiteFooter() {
  return (
    <footer className="border-t hairline bg-[rgb(var(--surface))]">
      <div className="mx-auto flex max-w-[1600px] flex-col gap-3 px-4 py-6 text-sm text-muted sm:flex-row sm:items-center">
