...
Study this roadmap first: [CS.md](../roadmaps/CS.md). Build each mini-project after its phase, then build the main portfolio project after Phase 105.
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 5](../roadmaps/CS.md#phase-5) | [CONTINUE TO CS PHASE 31](../roadmaps/CS.md#phase-31)
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 31](../roadmaps/CS.md#phase-31) | [CONTINUE TO CS PHASE 7](../roadmaps/CS.md#phase-7)
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 8](../roadmaps/CS.md#phase-8) | [CONTINUE TO CS PHASE 14](../roadmaps/CS.md#phase-14)
...
#### PROJECT: MULTI-FILE CLI TOOLKIT

#### SPECIFICATION

Build **Multi-File CLI Toolkit** as the capstone for **Programming Consolidation** - the point where you prove procedural fluency without a tutorial guiding each step. Pick ONE of these two briefs (both exercise the same skills):

- A **guessing game**: the program picks a random number, the user guesses repeatedly with feedback (higher/lower), and a `stats.py` module tracks wins, losses, and average guesses across sessions, persisted to a file.
- An **expense tracker**: the user adds expenses with a category and amount from the command line, a `storage.py` module saves/loads them from a file, and a `report.py` module prints totals per category and the overall total.

Whichever you pick, the finished project must:
...
1. Create `multi-file-cli-toolkit` with `src`, `tests`, and a small `main.py` entry point; create a Python virtual environment.
2. Before writing any code, write a one-page plan: what the program needs to do, which pieces of data it needs to track, and which file each function will live in - decide the module boundaries on paper first.
3. Implement the core loop and at least two functions split across two files that import from each other.
4. Add the file-persistence module so data survives a restart.
5. Add one normal example and one invalid-input example that is caught with `try`/`except` instead of crashing the program.
6. Run the project with `python -m src.main` and confirm it works end to end without looking anything up mid-build.

### Git Checkpoint

You have completed **MULTI-FILE CLI TOOLKIT**. Run the card's final command, test, or output check. From the portfolio repository root, review and save only this project's folder:

```bash
git status
git add -- oop/multi-file-cli-toolkit
git commit -m "feat(multi-file-cli-toolkit): complete multi-file cli toolkit"
```
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 15](../roadmaps/CS.md#phase-15) | [CONTINUE TO CS PHASE 21](../roadmaps/CS.md#phase-21)
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 25](../roadmaps/CS.md#phase-25) | [CONTINUE TO CS PHASE 27](../roadmaps/CS.md#phase-27)
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 27](../roadmaps/CS.md#phase-27) | [CONTINUE TO CS PHASE 26](../roadmaps/CS.md#phase-26)
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 26](../roadmaps/CS.md#phase-26) | [CONTINUE TO CS PHASE 28](../roadmaps/CS.md#phase-28)
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 35](../roadmaps/CS.md#phase-35) | [CONTINUE TO CS PHASE 38](../roadmaps/CS.md#phase-38)
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 38](../roadmaps/CS.md#phase-38) | [CONTINUE TO CS PHASE 36](../roadmaps/CS.md#phase-36)
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 36](../roadmaps/CS.md#phase-36) | [CONTINUE TO CS PHASE 40](../roadmaps/CS.md#phase-40)
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 41](../roadmaps/CS.md#phase-41) | [CONTINUE TO CS PHASE 46](../roadmaps/CS.md#phase-46)

<a id="cs-phase-46-project"></a>
### CS PHASE 46 MINI-PROJECT
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 53](../roadmaps/CS.md#phase-53) | [CONTINUE TO CS PHASE 57](../roadmaps/CS.md#phase-57)

<a id="cs-phase-57-project"></a>
### CS PHASE 57 MINI-PROJECT
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 57](../roadmaps/CS.md#phase-57) | [CONTINUE TO CS PHASE 59](../roadmaps/CS.md#phase-59)

<a id="cs-phase-59-project"></a>
### CS PHASE 59 MINI-PROJECT
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 59](../roadmaps/CS.md#phase-59) | [CONTINUE TO CS PHASE 65](../roadmaps/CS.md#phase-65)

<a id="cs-phase-65-project"></a>
### CS PHASE 65 MINI-PROJECT
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 65](../roadmaps/CS.md#phase-65) | [CONTINUE TO CS PHASE 69](../roadmaps/CS.md#phase-69)

<a id="cs-phase-69-project"></a>
### CS PHASE 69 MINI-PROJECT
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 69](../roadmaps/CS.md#phase-69) | [CONTINUE TO CS PHASE 75](../roadmaps/CS.md#phase-75)

<a id="cs-phase-75-project"></a>
### CS PHASE 75 MINI-PROJECT

#### PROJECT: LAYERED INVENTORY APP

#### SPECIFICATION

Build **Layered Inventory App** as a focused exercise for **Software Architecture**. Keep the data and interface small enough to finish, but implement the following behavior:
...
- Give the user one clear main action and keep all other features secondary.
- Use Software Architecture in the design and make that use visible in the code or interface.
- Keep the working data after restart when persistence is relevant.
- Handle empty input, invalid input, and the normal user journey without crashing.
...
3. Use Software Architecture in the design and make that use visible in the code or interface.
4. Keep the working data after restart when persistence is relevant.
5. Handle empty input, invalid input, and the normal user journey without crashing.
6. Add one normal example and one edge or failure example specifically for **Software Architecture**.
7. Run the project with `python -m src.main`, then run `pytest`; both must finish without errors.
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 75](../roadmaps/CS.md#phase-75) | [CONTINUE TO CS PHASE 77](../roadmaps/CS.md#phase-77)

<a id="cs-phase-77-project"></a>
### CS PHASE 77 MINI-PROJECT
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 77](../roadmaps/CS.md#phase-77) | [CONTINUE TO CS PHASE 88](../roadmaps/CS.md#phase-88)

<a id="cs-phase-88-project"></a>
### CS PHASE 88 MINI-PROJECT
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 88](../roadmaps/CS.md#phase-88) | [CONTINUE TO CS PHASE 86](../roadmaps/CS.md#phase-86)

<a id="cs-phase-86-project"></a>
### CS PHASE 86 MINI-PROJECT
...
> **PROJECT NAVIGATION:** [REVIEW CS PHASE 86](../roadmaps/CS.md#phase-86) | [CONTINUE TO CS PHASE 95](../roadmaps/CS.md#phase-95)
...
> **HOW PHASE 30 AND STORY XV WORK HERE:** Phase 30 (OOP Consolidation) is a required capstone-completion step: apply that roadmap's final engineering, integration, automation, migration, quality, or portfolio work. Phase 102 (Low-Level Design Interviews) does not add another product feature. It is post-build interview and presentation practice using the completed project. The software is functionally complete after Phase 30; do Phase 102 to complete the career-preparation roadmap.
>
...
1. **Phase 21 - Object Thinking:** Turn the workshop story into objects, responsibilities, and messages instead of one long procedural script.
2. **Phase 22 - Classes & Objects:** Create Tool, Member, Booking, WorkArea, and MaintenanceRecord classes with clear constructors.
3. **Phase 22 - Classes & Objects (state and behavior):** Add state-changing methods such as reserve, check_out, return_tool, and mark_unsafe; reject impossible transitions.
4. **Phase 23 - Encapsulation & Abstraction:** Keep fields private where changing them directly could break a rule, and expose safe methods or properties.
5. **Phase 23 - Encapsulation & Abstraction (abstraction):** Define repository, clock, and notification abstractions so business rules do not depend on SQLite or the screen.
6. **Phase 24 - Inheritance & Polymorphism:** Use inheritance only for genuinely shared member or tool behavior; demonstrate and test the chosen hierarchy.
7. **Phase 24 - Inheritance & Polymorphism (polymorphism):** Use polymorphism for different pricing, borrowing-limit, or notification policies behind one interface.
8. **Phase 25 - Composition:** Compose BookingService from repositories, policies, and a clock instead of building a deep inheritance tree.
9. **Phase 30 - OOP Consolidation (Python power tools):** Add useful dunder methods, dataclasses, enums, and properties so domain values are safe and readable.
10. **Phase 29 - Low-Level Design (relationships and modeling):** Draw the class relationships, then implement one-to-many member bookings and tool maintenance history.
11. **Phase 27 - Code Quality & Refactoring:** Identify one oversized class or duplicated rule and refactor it without changing behavior.
12. **Phase 26 - SOLID:** Review the design against all five SOLID principles and correct the two clearest violations.
13. **Phase 28 - Design Patterns (creational):** Use a factory to construct tools or policies from saved configuration without conditionals spread everywhere.
14. **Phase 28 - Design Patterns (structural):** Add an adapter between the domain repository interface and SQLite, plus a facade for the terminal UI.
15. **Phase 28 - Design Patterns (behavioral):** Use Observer for notifications or Strategy for booking rules; show why the pattern removes a real conditional.
16. **Phase 30 - OOP Consolidation (testing OOP):** Write unit tests for domain rules with fakes and integration tests for the SQLite adapter.
17. **Phase 29 - Low-Level Design (layers and clean architecture):** Separate domain, application, infrastructure, and interface folders so business rules point inward.
18. **Phase 29 - Low-Level Design (LLD method):** Create a short low-level design for a new wait-list feature, then implement it from the design.
19. **PHASE 30 - OOP Consolidation (REQUIRED CAPSTONE-COMPLETION STEP):** Polish the terminal screens, seed realistic data, add screenshots, choose an open-source license, and remove secrets or machine-specific paths.
20. **PHASE 102 - Low-Level Design Interviews (POST-BUILD PRACTICE; NO NEW PRODUCT FEATURE):** Practice a timed change such as adding a new tool category, then explain the design, tests, trade-offs, and complexity aloud.
...
You have completed **Phases 21-23: workshop domain model and protected state transitions**. Run the relevant application checks, then save this capstone milestone:
...
You have completed **Phases 24-25, 29-30: booking policies, composition, and domain relationships**. Run the relevant application checks, then save this capstone milestone:
...
You have completed **Phases 26-28: refactored services, patterns, SQLite adapter, and terminal facade**. Run the relevant application checks, then save this capstone milestone:
...
You have completed **Phase 30, Phase 29: automated tests, clean architecture, and wait-list design**. Run the relevant application checks, then save this capstone milestone:
...
You have completed **Phase 30: polished screens, demo data, documentation, and release assets**. Run the relevant application checks, then save this capstone milestone:
...
> **MAIN PROJECT NAVIGATION:** [REVIEW CS PHASE 29](../roadmaps/CS.md#phase-29) | [REVIEW CS PHASE 30](../roadmaps/CS.md#phase-30) | [RETURN TO THE CS ROADMAP](../roadmaps/CS.md#phase-index)
...
1. **Phase 5 - From Source Code to a Running Program:** Build a small command-line version first and trace how source code becomes a running process.
2. **Phase 31 - Complexity Analysis:** Measure time and memory for search and request-list operations at several dataset sizes; record Big O expectations.
3. **Phases 32-34 - Arrays & Strings, Linked Lists, Stacks/Queues/Deques:** Use arrays/lists, queues, and stacks for result pages, pending requests, and undoable moderation actions.
4. **Phase 35 - Recursion:** Add a recursive category tree operation and protect it from cycles and excessive depth.
5. **Phases 37-38 - Trees, Heaps & Priority Queues:** Use a heap for expiry reminders and a tree structure for category navigation.
...
14. **Phases 60-65 - Databases & Data Modeling:** Create a normalized PostgreSQL schema, migrations, indexes, and a transaction for approving a request.
15. **Phases 66-69 - Security Foundations & Application Security:** Add password hashing or external OAuth, secure sessions, authorization on every object, rate limiting, and audit logging.
...
You have completed **Phases 5, 31, 32-35: executable prototype, complexity evidence, core structures, and category recursion**. Run the relevant application checks, then save this capstone milestone:
...
You have completed **Phases 36-41, 43-46, 48: indexed search, scheduling, graph recommendations, and cohesive domain design**. Run the relevant application checks, then save this capstone milestone:
...
You have completed **Phases 50, 52-53, 55-59, 60-65, 66-69: process model, HTTP API, database transactions, and authorization**. Run the relevant application checks, then save this capstone milestone:
...
You have completed **Phases 72, 74, 77, 81, 85, 86, 88: test suite, observability, scaling evidence, and idempotent delivery**. Run the relevant application checks, then save this capstone milestone:
...
You have completed **Phases 95-98: safe demo workflow, documentation, license, and public portfolio assets**. Run the relevant application checks, then save this capstone milestone:
...
> **MAIN PROJECT NAVIGATION:** [REVIEW CS PHASE 95](../roadmaps/CS.md#phase-95) | [REVIEW CS PHASE 105](../roadmaps/CS.md#phase-105) | [RETURN TO THE CS ROADMAP](../roadmaps/CS.md#phase-index)
