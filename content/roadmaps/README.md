...
| Roadmap | Source file | Website route |
|---|---|---|
| Artificial Intelligence | [`AI.md`](./AI.md) | `/courses/artificial-intelligence` |
| Cloud Engineering | [`Cloud.md`](./Cloud.md) | `/courses/cloud` |
| Computer Science | [`CS.md`](./CS.md) | `/courses/computer-science` |
| Data | [`Data.md`](./Data.md) | `/courses/data` |
