...
export const roadmapRegistry: CourseDefinition[] = [
  ...
  { slug: "it-administration", title: "IT Administration", sourcePath: "content/roadmaps/IT_Administration.md", route: "/courses/it-administration", type: "roadmap", shortName: "IT Administration", icon: ServerCog, description: "Windows and Linux servers, Active Directory, Microsoft 365, networks, ERP, security, support, and tested recovery.", difficulty: "Beginner to job-ready", skills: ["Windows/Linux", "Active Directory", "Microsoft 365"], prerequisites: "Basic computer literacy", next: "networks", accent: "#b45309" },
